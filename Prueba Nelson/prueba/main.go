...
// 	"fmt"
// 	"net/http"
// 	jsonPrueba "prueba/model"
	
	
// )

// func Server(w http.ResponseWriter, r *http.Request) {
// 	var dataPrueba jsonPrueba.Json
// 	dataPrueba.Apertura ="Hola"
// 	dataPrueba.Seccion ="2"
// 	dataPrueba.Grid ="nacion"
// 	fmt.Println(dataPrueba)
	
// 	if err := r.ParseForm(); err != nil {
// 		fmt.Println("Error en los datos del formulario")
// 	}
...
//     files, err := Unzip("elecciones.gz", "uncompressed files")
...
func main() {
    ...
    datosComoBytes, err := ioutil.ReadFile("elecciones")
    if err != nil {
        log.Fatal(err)
    }
